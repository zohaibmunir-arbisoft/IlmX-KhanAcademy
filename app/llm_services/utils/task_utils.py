...
def invoke_and_get_report(user_prompt, model, start_time, invoke_type, pdf_str: str=None, input_tokens_total=0, output_tokens_total=0):
    try:
        if invoke_type == "images":
        ...
        result_json = {
            ...
            "token_usage": {
                "prompt_tokens": token_usage.prompt_tokens + input_tokens_total,
                "completion_tokens": token_usage.completion_tokens + output_tokens_total,
                "total_tokens": token_usage.total_tokens + input_tokens_total + output_tokens_total,
